...
<body>
        ...
        <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="#">Enseignants</a></li>
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">Formulaire Ajout Enseignant</h2>
        <div class="form-container">
        <a href="listeEnseignants.php" class="btn btn-primary mb-3">Voir la liste des enseignants</a>
            <form action="../../controllers/etudiantCtrl.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="matiere" name="mat" required autocomplete="off">
                </div>
